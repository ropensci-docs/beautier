...
Create a Bayesian phylogenetic inference model, as can be done by
BEAUti.
...
to create an inference model with a short MCMC, to be used in testing.
Use
[create_ns_inference_model](https://docs.ropensci.org/beautier/reference/create_ns_inference_model.md)
to create an inference model to estimate the marginal likelihood (aka
evidence) using a nested sampling approach.
