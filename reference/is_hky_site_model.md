# Determine if the object is a valid HKY site model, as created by [`create_hky_site_model`](https://docs.ropensci.org/beautier/reference/create_hky_site_model.md)

Determine if the object is a valid HKY site model, as created by
